        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><a href="index.html" class="text-white h2 mb-0"><strong>ARQYECO|VENTAJAS<span class="text-danger">.</span></strong></a></h1>
            </div>
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown arrow-top">
                      <li><a href="quees.blade.php"></a>¿Que es?</li>
                      <li><a href="principios.blade.php"></a>Principios</li>
                      <li><a href="proyectos.blade.php"></a>Empresas</li>
                    </ul>
                  </li>
                  <li class="has-children">
                    <a href="#">Aplicación en el mundo</a>
                    <ul class="dropdown arrow-top">
                      <li><a href="blog1.html">Africa</a></li>
                      <li><a href="blog3.html">America</a></li>
                      <li><a href="blog4.html">Asia</a></li>
                      <li><a href="blog2.html">Europa</a></li>
                      <li><a href="blog5.html">Oceania</a></li>
                    </ul>
                  </li>
