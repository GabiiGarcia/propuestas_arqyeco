...
<html lang="en">
  ...
  <body <img src="images/slider1.jpg" alt="">>
    ...
    <div class="site-section">
      <div class="container">
          ...
          <div class="row justify-content-center">
            ...
            <center><form action="#" class="p-5 bg-white border">
              <div class="row form-group">
                <div class="col-md-12">
                  <img src="images/pngwing.png" width="150px" height="150px">
                </div>
                <div class="col-md-12">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="message">Contraseña</label> 
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <center><input type="submit" value="Envíar" class="btn btn-primary  py-2 px-4 rounded-0"></center>
                </div>
              </div>
